...
impl S3ErrorCode {
    pub fn http_status(&self) -> u16 {
        match self {
            ...
            Self::InvalidKey => 400,
            Self::InvalidLocationConstraint => 400,
            ...
            Self::InvalidTag => 400,
            Self::MalformedACLError => 400,
            Self::MalformedXML => 400,
            Self::MaxMessageLengthExceeded => 400,
            Self::MethodNotAllowed => 405,
            Self::ObjectLockConfigurationNotFoundError => 404,
    ...
    pub fn default_message(&self) -> &'static str {
        match self {
            ...
            Self::InvalidBucketState => "The request is not valid for the current state of the bucket",
            Self::InvalidDigest => "The Content-MD5 or checksum value you specified is not valid",
            ...
            Self::MalformedPolicy => "Policy has invalid resource",
            Self::InvalidRange => "The requested range is not satisfiable",
            Self::InvalidRequest => "Invalid request",
            Self::InvalidTag => "The Tagging header is invalid",
            Self::MalformedACLError => "The XML you provided was not well-formed or did not validate against our published schema",
            ...
            Self::ObjectLockConfigurationNotFoundError => "Object Lock configuration does not exist for this bucket",
